...
const defaultExternal = builtInModules.concat(umd ? peerDeps : deps.concat(peerDeps));
...
const extensions = hasTypescript ? [...nodeResolveDefaults.extensions, '.ts', '.tsx'] : nodeResolveDefaults.extensions;
...
module.exports = {
  ...
  plugins: [isNode ? nodePolyfills() : null, nodeResolve({
    ...
    extensions
  }), replace(replacements), minify ? terser() : null, codeSplitting && ((writes = 0) => ({
    onwrite() {
